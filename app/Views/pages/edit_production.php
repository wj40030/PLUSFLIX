            ...
            <div class="form-group">
                ...
                <select name="genre_id" class="form-control" required>
                    <?php foreach($data['genres'] as $genre) : ?>
                        <option value="<?php echo $genre->id; ?>" <?php echo ($data['movie']->genre_id == $genre->id) ? 'selected' : ''; ?>>
                            <?php echo $genre->name; ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select name="streaming_platforms_id" class="form-control" required>
                    <?php foreach($data['streamings'] as $streaming) : ?>
                        <option value="<?php echo $streaming->id; ?>" <?php echo ($data['movie']->streaming_platforms_id == $streaming->id) ? 'selected' : ''; ?>>
